...
{ 
    ...
    double r_1 = mxGetPr(prhs[5])[0];
    double r_2 = mxGetPr(prhs[6])[0];
    double r_3 = mxGetPr(prhs[7])[0];
    int num_of_params = mxGetPr(prhs[8])[0];
    ...
    int cnt = 0;
    for(double r1=-r_bnd + r_1; r1 <= r_bnd + 0.0001 + r_1; r1+= r_diff){
    for(double r2=-r_bnd + r_2; r2 <= r_bnd + 0.0001 + r_2; r2+= r_diff){
    for(double r3=-r_bnd + r_3; r3 <= r_bnd + 0.0001 + r_3; r3+= r_diff){
